<?php
//para evitar que se pueda ingresar por medio de la url
if (!defined('ABSPATH'))
    exit;
...
//cargar los hooks de wordpress
//para saber sobre los hooks hay que ver la documentacion de wordpress
...
register_nav_menus(
    array(
        'main-menu' => esc_html__('Main menu', 'my_theme'), //lo que pusimos en Text Domain: my_theme = temas de traduccion
...
add_action('after-setup_theme','my_theme_logo_setup');

//arreglar tamaño del log
