...
function my_widgets_register_scripts()
{
    ...
    wp_register_script('pdfcontainer-script', plugins_url('assets/js/pdfcontainer.js', __FILE__), ['jquery'], '1.0.0', true);
    wp_register_style('pdfcontainer-style', plugins_url('assets/styles/css/pdfcontainer.css', __FILE__), [], "1.0.0", "all");
}
...
require_once plugin_dir_path(__FILE__) . '/widgets/pdfcontainer.php';